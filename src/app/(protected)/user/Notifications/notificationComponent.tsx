...
const NotificationComponent = ({ notification }: NotificationComponentProps) => {
    if (notification?.type === "LIKE") {
        return (
            <div className={`${notification?.read===false && "bg-blue-200"} flex w-full items-center bg-gray-50 hover:bg-gray-100 transition-colors rounded-xl p-4 gap-4 border border-gray-200 shadow-sm`}>
